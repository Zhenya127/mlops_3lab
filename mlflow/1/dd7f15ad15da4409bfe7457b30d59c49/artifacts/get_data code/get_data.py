...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/ml_src/Desktop/mlops_3lab/"
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("get_data")
 
key = "AIzaSyCKqUktYJfBpeKfZKkGkqOeNMDdw6xH9V4"
api = Api(api_key=key)
query = "'La-La Land'"
...
with mlflow.start_run():
    ...
    mlflow.log_artifact(local_path="/home/ml_src/Desktop/mlops_3lab/scripts/get_data.py",
                        artifact_path="get_data code")
    mlflow.end_run()
 
with open('/home/ml_src/Desktop/mlops_3lab/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))